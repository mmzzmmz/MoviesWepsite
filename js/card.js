...
async function getMoviesDetailsById(id, index) {
  ...
  // use a dark gradient overlay on top of the poster to make the hero readable
  detailsContainer.style.backgroundImage = `linear-gradient(rgba(3,6,10,0.62), rgba(3,6,10,0.72)), url("${basisImgUrl}${data[index].poster_path}")`;
